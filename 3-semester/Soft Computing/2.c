...
// Function to train the ADALINE network
void train_adaline(float inputs[][2], float *outputs, float *weights, int input_size, int
num_samples) {
 int epoch;
 bool weightChanged;
...
int main() {
 ...
 printf("\n");
 train_adaline(inputs, outputs, weights, input_size, num_samples);
 return 0;
}